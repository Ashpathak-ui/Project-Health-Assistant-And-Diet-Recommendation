...
allergies = st.sidebar.selectbox("Allergies",["Allergies","No Allergies"])
...
if tab2:
    question=st.text_area("Ask about Health",placeholder="eg: Good Source of protein for vegetarians")
    if st.button("Ask AI"):
        db=load_rag()
